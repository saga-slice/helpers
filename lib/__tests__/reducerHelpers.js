...
describe('reducer helpers', () => {
    ...
    test(`crudReducers: should return an object of reducers`, () => {
        ...
        expect(reducers).toHaveProperty(['patchSuccess'], reducerHelpers.updateSuccess);
        ...
        expect(reducers).toHaveProperty(['patch'], reducerHelpers.loadingReducer);
        ...
        expect(reducers).toHaveProperty(['patchFail'], reducerHelpers.failReducer);
    ...
    test(`crudReducers: should add done reducers`, () => {
        ...
        expect(reducers).toHaveProperty(['patchDone'], reducerHelpers.noop);
